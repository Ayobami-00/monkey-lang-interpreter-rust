...
/// Trait implemented by all AST nodes for Monkey language.
pub trait Node {
    /// Returns the literal value of the token associated with this node.
    fn token_literal(&self) -> String;
    /// Returns a string representation of the node for pretty-printing.
    fn print_string(&self) -> String;
}

/// Enum representing all statement types in the Monkey AST.
#[derive(Debug, Clone)]
...
/// Enum representing all expression types in the Monkey AST.
...
/// The root node of every Monkey program.
pub struct Program {
...
/// Represents a let statement in Monkey.
#[derive(Debug, Clone)]
...
/// Represents an identifier in Monkey.
#[derive(Debug, Default, Clone)]
...
/// Represents a return statement in Monkey.
#[derive(Debug, Default, Clone)]
...
/// Represents an expression statement in Monkey.
#[derive(Debug, Default, Clone)]

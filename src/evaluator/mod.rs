...
/// Evaluates Monkey AST nodes and manages program environment.
...
impl Evaluator {
    ...
    /// Evaluates a parsed Monkey program AST and returns the result.
    ...
    /// Evaluates a single statement in the program.
    ...
    /// Evaluates an expression in the program.
    ...
    /// Evaluates an index expression in the program.
    ...
    /// Evaluates an array index expression in the program.
    ...
    /// Evaluates a hash index expression in the program.
    ...
    /// Applies a function to a set of arguments.
    ...
    /// Creates a new environment for a function call.
    ...
    /// Unwraps a return value from a function call.
    ...
    /// Converts a native boolean to a boolean object.
